	...
	return (
		<>
			<div className='flex md:my-4 my-2 bg-white dark:bg-gray-700 rounded animate-pulse'>
				<div className='md:w-1/3 h-44 bg-gray-200 dark:bg-gray-500 rounded-l' />
	...
	return (
		<div className='flex flex-col space-y-3 animate-pulse'>
			<div className='flex flex-col space-y-2'>
				<span className='h-4 w-3/4 bg-gray-200 dark:bg-gray-500 rounded' />
				<span className='h-4 w-full bg-gray-200 dark:bg-gray-500 rounded' />
			</div>
			<div className='flex flex-col space-y-2'>
				<span className='h-4 w-3/4 bg-gray-200 dark:bg-gray-500 rounded' />
...
export function CategorySkeleton() {
	return (
		<div className='flex flex-col space-y-3 animate-pulse'>
			<div className='flex justify-between'>
				<span className='h-4 w-1/4 bg-gray-200 dark:bg-gray-500 rounded' />
