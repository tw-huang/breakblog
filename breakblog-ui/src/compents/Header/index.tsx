	...
	return (
		<div className='flex justify-between items-center md:h-20 h-12 md:px-8 px-2 border-solid border-b-2 border-gray-200'>
			...
			<div className='font-medium'>
				<LinkTo to={"/"} className='hover:text-gray-400 hover:underline'>首页</LinkTo>
				<span className='ml-4 hover:text-gray-400 hover:underline'>时间轴</span>
				<span className='ml-4 hover:text-gray-400 hover:underline'>关于我</span>
			</div>
		</div>
	)
}
